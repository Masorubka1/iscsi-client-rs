//! This module defines common structures for iSCSI Text PDUs.
//! It includes flags for handling text-based key-value pairs.
...
/// A zero-copy wrapper for the flags in a Text PDU.
#[repr(transparent)]
